                            ...
                            <div class="container-fluid padding3">
                                <div class="row">
                                    <div class="col-xl-4 col-lg-4 col-md-4 col-sm-12 mapimg">
                                        ...
                                        SHOP <br>
                                        SNEAKER</h1>
                                            <span>Bán giày được nhiêu tiền đâu nè! Ủng hộ nhau đi</span>
                                            <a href="#">Buy now</a>
                                        </div>
                                    </div>
                                                    ...
                                                    <div class="container">
                                                        <div class="carousel-caption text">
                                                            <div class="row">
                                                                <div class="col-md-12">
                                                                    <div class="img_bg">
                                                                        <figure><img src="images/capp2.png" /></figure>
                                                                    </div>
                                                                </div>
                                                            </div>
                                                    ...
                                                    <div class="container">
                                                        <div class="carousel-caption text">
                                                            <div class="row">
                                                                <div class="col-md-12">
                                                                    <div class="img_bg">
                                                                        <figure><img src="images/capp1.png" /></figure>
                                                                    </div>
                                                                </div>
                                                            </div>
                                                    ...
                                                    <div class="container">
                                                        <div class="carousel-caption text">
                                                            <div class="row">
                                                                <div class="col-md-12">
                                                                    <div class="img_bg">
                                                                        <figure><img src="images/capp.png" /></figure>
                                                                    </div>
                                                                </div>
                                                            </div>
                ...
                <div class="container">
                        ...
                        <div class="col-md-12">
                            <div class="title">
                                ...
                                <ul class="categiri">
                                    ...
                                    <li><a href="#shoes">Nhãn hiệu</a></li>
                                    <li><a href="#">Giày nam</a></li>
                                    <li><a href="#jewellery">Giày nữ</a></li>
                                    <li><a href="#">Giày trẻ em</a></li>
                                    <li><a href="#kids">Thể thao</a></li>
                    ...
                    <div id="shoes" class="shoes-bg">
                        ...
                        <div class="row">
                            ...
                            <%for (SanPham o : dao.getAllProduct()) {
                                    %>
                            <div class="col-xl-3 col-lg-3 col-md-6 col-sm-12 margintop">
                                <div class="shoes-box">
                                    <h5>Sale</h5>
                                     <a href="Detail.jsp?HomePage=<%=o.getIdSanPham()%>"><img src="<%=o.getHinhAnh()%>"/></a>
                                
                                <h4>Giá $<span class="nolmal"><%=o.getGia()%></span></h4>

                                </div>
                                <a class="buynow" href="Detail.jsp?HomePage=<%=o.getIdSanPham()%>">Buy now</a>
                            </div>
                                                               <%}%>
